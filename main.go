...
import (
	...
	"mydomain/myproject/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "03a61683.mydomain",
	})
	if err != nil {
	...
	if err = (&mygroupv1.MyKind{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "MyKind")
		os.Exit(1)
	}
